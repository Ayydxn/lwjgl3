 ...
 * }</code></pre>
 */
public class ULGPUDriver extends Struct<ULGPUDriver> implements NativeResource {
    ...
    protected ULGPUDriver(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected ULGPUDriver create(long address, @Nullable ByteBuffer container) {
        return new ULGPUDriver(address, container);
    }
    ...
    public static ULGPUDriver malloc() {
        return new ULGPUDriver(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static ULGPUDriver calloc() {
        return new ULGPUDriver(nmemCallocChecked(1, SIZEOF), null);
    }

    /** Returns a new {@code ULGPUDriver} instance allocated with {@link BufferUtils}. */
    public static ULGPUDriver create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return new ULGPUDriver(memAddress(container), container);
    }

    /** Returns a new {@code ULGPUDriver} instance for the specified memory address. */
    public static ULGPUDriver create(long address) {
        return new ULGPUDriver(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static @Nullable ULGPUDriver createSafe(long address) {
        return address == NULL ? null : new ULGPUDriver(address, null);
    }
    ...
    public static ULGPUDriver.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static ULGPUDriver malloc(MemoryStack stack) {
        return new ULGPUDriver(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static ULGPUDriver calloc(MemoryStack stack) {
        return new ULGPUDriver(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<ULGPUDriver, Buffer> implements NativeResource {
         ...
         * by {@link ULGPUDriver#SIZEOF}, and its mark will be undefined.</p>
         *
