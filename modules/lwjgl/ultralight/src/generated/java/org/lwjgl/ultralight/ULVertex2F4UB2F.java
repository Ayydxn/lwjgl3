...
public class ULVertex2F4UB2F extends Struct<ULVertex2F4UB2F> implements NativeResource {
    ...
    protected ULVertex2F4UB2F(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected ULVertex2F4UB2F create(long address, @Nullable ByteBuffer container) {
        return new ULVertex2F4UB2F(address, container);
    }
    ...
    public static ULVertex2F4UB2F malloc() {
        return new ULVertex2F4UB2F(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static ULVertex2F4UB2F calloc() {
        return new ULVertex2F4UB2F(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static ULVertex2F4UB2F create() {
        ...
        return new ULVertex2F4UB2F(memAddress(container), container);
    }
    ...
    public static ULVertex2F4UB2F create(long address) {
        return new ULVertex2F4UB2F(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static @Nullable ULVertex2F4UB2F createSafe(long address) {
        return address == NULL ? null : new ULVertex2F4UB2F(address, null);
    }
    ...
    public static ULVertex2F4UB2F.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static ULVertex2F4UB2F malloc(MemoryStack stack) {
        return new ULVertex2F4UB2F(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static ULVertex2F4UB2F calloc(MemoryStack stack) {
        return new ULVertex2F4UB2F(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static float npos(long struct, int index) {
        return memGetFloat(struct + ULVertex2F4UB2F.POS + check(index, 2) * 4);
    }
    ...
    public static byte ncolor(long struct, int index) {
        return memGetByte(struct + ULVertex2F4UB2F.COLOR + check(index, 4) * 1);
    }
    ...
    public static float nobj(long struct, int index) {
        return memGetFloat(struct + ULVertex2F4UB2F.OBJ + check(index, 2) * 4);
    }
    ...
    public static void npos(long struct, int index, float value) {
        memPutFloat(struct + ULVertex2F4UB2F.POS + check(index, 2) * 4, value);
    }
    ...
    public static void ncolor(long struct, int index, byte value) {
        memPutByte(struct + ULVertex2F4UB2F.COLOR + check(index, 4) * 1, value);
    }
    ...
    public static void nobj(long struct, int index, float value) {
        memPutFloat(struct + ULVertex2F4UB2F.OBJ + check(index, 2) * 4, value);
    }
    ...
    public static class Buffer extends StructBuffer<ULVertex2F4UB2F, Buffer> implements NativeResource {
         ...
         * by {@link ULVertex2F4UB2F#SIZEOF}, and its mark will be undefined.</p>
         *
