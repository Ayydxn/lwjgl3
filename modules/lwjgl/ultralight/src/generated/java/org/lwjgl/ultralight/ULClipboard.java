 ...
 * }</code></pre>
 */
public class ULClipboard extends Struct implements NativeResource {
    ...
    public static ULClipboard malloc() {
        return wrap(ULClipboard.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static ULClipboard calloc() {
        return wrap(ULClipboard.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@code ULClipboard} instance allocated with {@link BufferUtils}. */
    public static ULClipboard create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(ULClipboard.class, memAddress(container), container);
    }

    /** Returns a new {@code ULClipboard} instance for the specified memory address. */
    public static ULClipboard create(long address) {
        return wrap(ULClipboard.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static ULClipboard createSafe(long address) {
        return address == NULL ? null : wrap(ULClipboard.class, address);
    }
    ...
    @Nullable
    public static ULClipboard.Buffer createSafe(long address, int capacity) {
    ...
    public static ULClipboard malloc(MemoryStack stack) {
        return wrap(ULClipboard.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static ULClipboard calloc(MemoryStack stack) {
        return wrap(ULClipboard.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<ULClipboard, Buffer> implements NativeResource {
         ...
         * by {@link ULClipboard#SIZEOF}, and its mark will be undefined.
         *
