 ...
 * }</code></pre>
 */
public class ULFileSystem extends Struct implements NativeResource {
    ...
    public static ULFileSystem malloc() {
        return wrap(ULFileSystem.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static ULFileSystem calloc() {
        return wrap(ULFileSystem.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@code ULFileSystem} instance allocated with {@link BufferUtils}. */
    public static ULFileSystem create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(ULFileSystem.class, memAddress(container), container);
    }

    /** Returns a new {@code ULFileSystem} instance for the specified memory address. */
    public static ULFileSystem create(long address) {
        return wrap(ULFileSystem.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static ULFileSystem createSafe(long address) {
        return address == NULL ? null : wrap(ULFileSystem.class, address);
    }
    ...
    @Nullable
    public static ULFileSystem.Buffer createSafe(long address, int capacity) {
    ...
    public static ULFileSystem malloc(MemoryStack stack) {
        return wrap(ULFileSystem.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static ULFileSystem calloc(MemoryStack stack) {
        return wrap(ULFileSystem.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<ULFileSystem, Buffer> implements NativeResource {
         ...
         * by {@link ULFileSystem#SIZEOF}, and its mark will be undefined.
         *
