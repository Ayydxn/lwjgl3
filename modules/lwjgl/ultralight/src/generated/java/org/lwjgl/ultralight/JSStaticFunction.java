 ...
 * }</code></pre>
 */
public class JSStaticFunction extends Struct<JSStaticFunction> implements NativeResource {
    ...
    protected JSStaticFunction(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected JSStaticFunction create(long address, @Nullable ByteBuffer container) {
        return new JSStaticFunction(address, container);
    }
    ...
    public static JSStaticFunction malloc() {
        return new JSStaticFunction(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static JSStaticFunction calloc() {
        return new JSStaticFunction(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static JSStaticFunction create() {
        ...
        return new JSStaticFunction(memAddress(container), container);
    }
    ...
    public static JSStaticFunction create(long address) {
        return new JSStaticFunction(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static @Nullable JSStaticFunction createSafe(long address) {
        return address == NULL ? null : new JSStaticFunction(address, null);
    }
    ...
    public static JSStaticFunction.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static JSStaticFunction malloc(MemoryStack stack) {
        return new JSStaticFunction(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static JSStaticFunction calloc(MemoryStack stack) {
        return new JSStaticFunction(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<JSStaticFunction, Buffer> implements NativeResource {
         ...
         * by {@link JSStaticFunction#SIZEOF}, and its mark will be undefined.</p>
         *
