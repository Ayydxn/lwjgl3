 ...
 * }}</pre>
 */
public class ULMatrix4x4 extends Struct<ULMatrix4x4> implements NativeResource {
    ...
    protected ULMatrix4x4(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected ULMatrix4x4 create(long address, @Nullable ByteBuffer container) {
        return new ULMatrix4x4(address, container);
    }
    ...
    public static ULMatrix4x4 malloc() {
        return new ULMatrix4x4(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static ULMatrix4x4 calloc() {
        return new ULMatrix4x4(nmemCallocChecked(1, SIZEOF), null);
    }

    /** Returns a new {@code ULMatrix4x4} instance allocated with {@link BufferUtils}. */
    public static ULMatrix4x4 create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return new ULMatrix4x4(memAddress(container), container);
    }

    /** Returns a new {@code ULMatrix4x4} instance for the specified memory address. */
    public static ULMatrix4x4 create(long address) {
        return new ULMatrix4x4(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static @Nullable ULMatrix4x4 createSafe(long address) {
        return address == NULL ? null : new ULMatrix4x4(address, null);
    }
    ...
    public static ULMatrix4x4.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static ULMatrix4x4 malloc(MemoryStack stack) {
        return new ULMatrix4x4(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static ULMatrix4x4 calloc(MemoryStack stack) {
        return new ULMatrix4x4(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static float ndata(long struct, int index) {
        return memGetFloat(struct + ULMatrix4x4.DATA + check(index, 16) * 4);
    }
    ...
    public static void ndata(long struct, int index, float value) {
        memPutFloat(struct + ULMatrix4x4.DATA + check(index, 16) * 4, value);
    }
    ...
    public static class Buffer extends StructBuffer<ULMatrix4x4, Buffer> implements NativeResource {
         ...
         * by {@link ULMatrix4x4#SIZEOF}, and its mark will be undefined.</p>
         *
