 ...
 * }</code></pre>
 */
public class JSStaticValue extends Struct<JSStaticValue> implements NativeResource {
    ...
    protected JSStaticValue(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected JSStaticValue create(long address, @Nullable ByteBuffer container) {
        return new JSStaticValue(address, container);
    }
    ...
    public static JSStaticValue malloc() {
        return new JSStaticValue(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static JSStaticValue create(long address) {
        return new JSStaticValue(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static @Nullable JSStaticValue createSafe(long address) {
        return address == NULL ? null : new JSStaticValue(address, null);
    }
    ...
    public static JSStaticValue.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static JSStaticValue malloc(MemoryStack stack) {
        return new JSStaticValue(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static JSStaticValue calloc(MemoryStack stack) {
        return new JSStaticValue(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<JSStaticValue, Buffer> implements NativeResource {
         ...
         * by {@link JSStaticValue#SIZEOF}, and its mark will be undefined.</p>
         *
