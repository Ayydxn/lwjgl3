 ...
 * }</code></pre>
 */
public class ULSurfaceDefinition extends Struct<ULSurfaceDefinition> implements NativeResource {
    ...
    protected ULSurfaceDefinition(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected ULSurfaceDefinition create(long address, @Nullable ByteBuffer container) {
        return new ULSurfaceDefinition(address, container);
    }
    ...
    public static ULSurfaceDefinition malloc() {
        return new ULSurfaceDefinition(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static ULSurfaceDefinition calloc() {
        return new ULSurfaceDefinition(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static ULSurfaceDefinition create() {
        ...
        return new ULSurfaceDefinition(memAddress(container), container);
    }
    ...
    public static ULSurfaceDefinition create(long address) {
        return new ULSurfaceDefinition(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static @Nullable ULSurfaceDefinition createSafe(long address) {
        return address == NULL ? null : new ULSurfaceDefinition(address, null);
    }
    ...
    public static ULSurfaceDefinition.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static ULSurfaceDefinition malloc(MemoryStack stack) {
        return new ULSurfaceDefinition(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static ULSurfaceDefinition calloc(MemoryStack stack) {
        return new ULSurfaceDefinition(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<ULSurfaceDefinition, Buffer> implements NativeResource {
         ...
         * by {@link ULSurfaceDefinition#SIZEOF}, and its mark will be undefined.</p>
         *
