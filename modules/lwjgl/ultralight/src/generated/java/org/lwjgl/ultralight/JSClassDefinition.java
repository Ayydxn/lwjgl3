 ...
 * }</code></pre>
 */
public class JSClassDefinition extends Struct implements NativeResource {
    ...
    public static JSClassDefinition malloc() {
        return wrap(JSClassDefinition.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static JSClassDefinition calloc() {
        return wrap(JSClassDefinition.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static JSClassDefinition create() {
        ...
        return wrap(JSClassDefinition.class, memAddress(container), container);
    }
    ...
    public static JSClassDefinition create(long address) {
        return wrap(JSClassDefinition.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static JSClassDefinition createSafe(long address) {
        return address == NULL ? null : wrap(JSClassDefinition.class, address);
    }
    ...
    @Nullable
    public static JSClassDefinition.Buffer createSafe(long address, int capacity) {
    ...
    public static JSClassDefinition malloc(MemoryStack stack) {
        return wrap(JSClassDefinition.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static JSClassDefinition calloc(MemoryStack stack) {
        return wrap(JSClassDefinition.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static int nversion(long struct) { return UNSAFE.getInt(null, struct + JSClassDefinition.VERSION); }
    ...
    public static void nversion(long struct, int value) { UNSAFE.putInt(null, struct + JSClassDefinition.VERSION, value); }
    ...
    public static class Buffer extends StructBuffer<JSClassDefinition, Buffer> implements NativeResource {
         ...
         * by {@link JSClassDefinition#SIZEOF}, and its mark will be undefined.
         *
